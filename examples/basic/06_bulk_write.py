...
def _run(products) -> None:
    ...
    products.insert_many([
        {"_id": "SKU001", "name": "Widget A",  "price": 9.99,  "stock": 100, "category": "widgets"},
        {"_id": "SKU002", "name": "Widget B",  "price": 14.99, "stock": 50,  "category": "widgets"},
        {"_id": "SKU003", "name": "Gadget X",  "price": 29.99, "stock": 30,  "category": "gadgets"},
        {"_id": "SKU004", "name": "Gadget Y",  "price": 49.99, "stock": 10,  "category": "gadgets"},
    ...
    result = products.bulk_write([
        InsertOne({"_id": "SKU006", "name": "Thingamajig", "price": 7.50, "stock": 75, "category": "misc"}),
        UpdateOne({"_id": "SKU001"}, {"$inc": {"stock": -20}, "$set": {"on_sale": True}}),
        UpdateMany({"category": "gadgets"}, {"$inc": {"price": -5.0}}),
        ReplaceOne({"_id": "SKU005"}, {"_id": "SKU005", "name": "Super Doohickey", "price": 6.99, "stock": 180, "category": "misc", "upgraded": True}),
    ...
    for doc in products.find({}).sort("_id", 1):
        ...
        print(f"  {doc['_id']}  {doc['name']:20s}  ${doc['price']:>6.2f}  stock={doc['stock']:>3}{flag_str}")
