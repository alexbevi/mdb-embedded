//! Oplog pub/sub hub and change streams (Python `smongo.oplog` + redb engine oplog).
...
/// Local change stream -- yields MongoDB-format change events from hub notifications.
#[pyclass(module = "smongo._smongo_core")]
